...
```{r echo=FALSE, message=FALSE, fig.show="hold", fig.align='center', out.width="20%"}
...
## Applying preprocessing steps - juice and bake
\tiny
```{r}
...
- youtube.com/channel/UCTTBgWyJl2HrrhQOOc710kA
- rebeccabarter.com/blog
